...
class MenuButtonTree extends Component{
    ...
    componentDidMount(){
        this.props.rootStore.relevantRoleButtonStore.loadMenuButtonTree();
        this.props.rootStore.relevantRoleButtonStore.setOpid(this.props.operationId);
    }
    ...
    render(){
        const store=this.props.rootStore.relevantRoleButtonStore;
        return (
            <div>
                <Tree checkable
